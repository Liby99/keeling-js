    ...
    res.render(file, {}, function (err, html) {
        ...
        if (err) {
            ...
            if (file === "error") {
                ...
                if (req.query.code) {
                    res.send("<h2>Error " + req.query.code + ": " + req.query.msg + "</h2>");
                }
                else {
...
class Router {
    ...
    router(req, res) {
        ...
        res.error = function (code, msg) {
            res.redirect("/" + self.errorPage + ".html?code=" + code + "&msg=" + msg);
        };
        ...
        try {
            processRoute(self.routerDir, req, res);
        }
        catch (err) {
