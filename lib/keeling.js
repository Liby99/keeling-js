...
class Keeling {
    ...
    constructor() {
        ...
        process.env.PUBLIC_DIR = path.join(BASE_DIR + config["public_directory"] + "/");
        process.env.AJAX_DIR = path.join(BASE_DIR + config["ajax_directory"] + "/");
        process.env.ROUTER_DIR = path.join(BASE_DIR + config["router_directory"] + "/");
        process.env.SCHEDULE_DIR = path.join(BASE_DIR + config["schedule_directory"] + "/");
        
        AJAX_REQ = "/" + config["ajax_directory"] + "/*";
